...
public class CreateContactSteps  {
	...
	public void enter_firstNameField(){
		WebElement elementFirstName = driver.findElement(By.id("firstNameField"));
		elementFirstName.sendKeys("");
	}
	@Given("Enter LastName Field")
	public void enter_lastNameField(){
		driver.findElement(By.id("lastNameField")).sendKeys("");
	}
